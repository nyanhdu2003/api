        ...
        public static async Task InitializeAsync(IServiceProvider serviceProvider)
        {
            ...
            ))
            {
                ...
                var roles = new[]
                {
                    ...
                    new Role { Id = Guid.NewGuid(), Name = "User", Description = "Student role", IsActive = true }
                };
                await context.Roles.AddRangeAsync(roles);
                await context.SaveChangesAsync();

                // Tạo dữ liệu UserRoles
                var userRoles = new List<UserRoles>
                {
                    new UserRoles { UserId = users[0].Id, RoleId = roles[0].Id }, // John Doe - Admin
                    new UserRoles { UserId = users[1].Id, RoleId = roles[1].Id }  // Jane Smith - User
                };
